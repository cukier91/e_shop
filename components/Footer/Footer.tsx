			...
			<div className="max-w-5xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
				...
				<div className="flex justify-center mt-8">
					<div className="text-center sm:text-left">
						<p className="text-lg font-bold text-gray-900">Dane kontaktowe</p>
						...
						<ul className="mt-5 space-y-4 text-sm">
							<li>
								...
								>
									...
									<span className="text-gray-700">biuro@pgprojekty.pl</span>
								</a>
							</li>
							...
							<li>
								...
								>
									...
									<span className="text-gray-700">+48 601 840 707</span>
								</a>
							</li>
							...
							<li className="flex items-start justify-center gap-1.5 sm:justify-start">
								...
								<address className="-mt-0.5 not-italic text-gray-700">
									Mosiężna 31/43<br/> 53-441 Wrocław
								</address>
							</li>
							<li>
								<iframe
